...
export const DOMAINS: Domain[] = [
  {
    ...
    arc: "Real-time fraud surfaces — from raw card swipe to model-scored alert in under 250ms — on Spark Structured Streaming, Kafka, and AWS. Embedded foundation models for KYC document understanding feed the same decision plane.",
    achievements: [
      "Streaming fraud detection at 50K events/second with sub-second decisioning",
    ...
    scale: [
      ...
      { label: "Latency P99", value: "250ms" },
      { label: "Models in prod", value: "5" },
    ],
    projectId: "fintech",
    accent: "cyan",
  },
